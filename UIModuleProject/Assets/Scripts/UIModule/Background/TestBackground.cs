...
namespace UIModule
{
    ...
    public class TestBackground : BaseBackground
    {
        ...
        protected override void OnBackgroundShow()
        {
            // 표시 시 로직
        }

        protected override void OnBackgroundHide()
        {
            // 숨김 시 로직
        }

        protected override void OnBackgroundDestroy()
        {
            // 버튼 클릭 이벤트 해제
            if (_buttonConfirm != null)
            {
